...
const replacements = [
  ...
  // Padding & Heights
  { from: /py-24/g, to: 'py-12' },
  { from: /py-16 md:py-24/g, to: 'py-8 md:py-12' },
  { from: /py-16/g, to: 'py-10' },
  { from: /py-20/g, to: 'py-12' },
  { from: /h-\[80vh\]/g, to: 'h-[60vh]' },
  { from: /h-\[85vh\]/g, to: 'h-[65vh]' },
  { from: /min-h-\[600px\]/g, to: 'min-h-[400px]' },
  { from: /min-h-\[500px\]/g, to: 'min-h-[350px]' },
];
