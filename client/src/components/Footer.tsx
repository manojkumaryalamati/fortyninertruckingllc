...
export default function Footer() {
  return (
    <footer className="bg-zinc-100 text-zinc-900 border-t border-zinc-200">
      <div className="w-full max-w-[1800px] mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          <div className="space-y-6">
            <Link href="/">
              <div className="block cursor-pointer foooter-image-css">
                <img 
                  src={logo} 
                  alt="FortyNiner Trucking" 
                  className="h-45 w-auto brightness-0 object-contain drop-shadow-md footer-image-margin" 
                />
              </div>
            </Link>
