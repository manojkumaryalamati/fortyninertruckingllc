...
export default function Careers() {
  ...
  return (
    <div className="min-h-screen bg-[var(--surface-2)] text-[var(--text)] font-sans pt-24 md:pt-32 pb-12">
      <Navbar />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            <div className="text-lg text-[var(--text-muted)] leading-relaxed space-y-4">
              <p>
                FortyNinerTrucking is looking to add Drivers to Our Team. We are
                looking for Commercial Drivers for Long Haul and Daily Local
                Driving jobs.
              </p>
              <p>
                Weekends are not mandatory, maybe necessary for Long haul
                projects.
              </p>
              <p className="font-bold text-[var(--text)]">
                Class A or Class B license (CDL) required to apply for multiple
                positions available.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Respect and open communication.",
                },
                {
                  title: "Well-Maintained Equipment",
                  desc: "Safe, compliant, and reliable trucks.",
                },
                {
          ...
          <Card className="border-none shadow-xl bg-white border border-[var(--border)]">
            <CardContent className="p-8 md:p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="phone" className="text-[var(--text-muted)]">
                    Phone Number
                  </Label>
                  <Input
                    id="phone"
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full h-10 rounded-md border border-[var(--border)] bg-[var(--surface-2)] px-3 py-2 text-sm"
                  >
                ...
                <div className="space-y-2">
                  <Label htmlFor="license" className="text-[var(--text-muted)]">
                    CDL Number
                  </Label>
                  <Input
                    id="license"
