    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-[var(--primary)]/20">
      ...
      <section className="relative min-h-[350px] h-[45vh] md:min-h-[500px] md:h-[calc(100vh-72px)] w-full overflow-hidden mt-[72px] lg:h-[calc(100vh-112px)] lg:mt-[112px]">
        ...
        <motion.div 
          ...
          className="absolute bottom-8 left-4 md:left-12 z-20 flex flex-row items-center gap-3 md:gap-4"
        >
          <Link href="/services">
            <Button variant="outline" className="h-9 px-4 text-xs md:h-12 md:px-8 md:text-base font-bold tracking-wide border-2 border-[var(--primary)] text-[var(--primary)] hover:bg-[var(--primary)] hover:text-white bg-white/90 backdrop-blur-sm rounded-full min-w-[100px] md:min-w-[160px] shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              Our Services
            </Button>
          </Link>
          <Link href="/contact">
            <Button className="h-9 px-4 text-xs md:h-12 md:px-8 md:text-base font-bold tracking-wide bg-[var(--primary)] hover:bg-[var(--primary)]/90 text-white rounded-full min-w-[100px] md:min-w-[160px] shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              Get A Quote
            </Button>
          </Link>
        </motion.div>
