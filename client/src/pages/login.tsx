      ...
      <div className="w-full max-w-[1000px] grid md:grid-cols-2 gap-0 bg-white rounded-3xl shadow-2xl overflow-hidden border border-zinc-100">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" className="w-full h-12 font-bold text-base bg-zinc-900 text-white hover:bg-zinc-800 rounded-xl shadow-lg shadow-zinc-900/20" disabled={isLoggingIn}>
        ...
        <div className="hidden md:block relative bg-zinc-900">
          ...
          <div className="relative h-full flex flex-col justify-between p-12 text-white">
            <div className="space-y-2">
              <div className="h-12 w-12 bg-white/10 rounded-xl flex items-center justify-center backdrop-blur-sm border border-white/10 mb-6">
            ...
            <div className="space-y-4">
              <div className="flex -space-x-4">
                {[1,2,3,4].map(i => (
                  <div key={i} className="h-10 w-10 rounded-full border-2 border-zinc-900 bg-zinc-700 flex items-center justify-center text-xs font-bold">
                    {i}
                  </div>
                ))}
              </div>
