...
export default function About() {
  return (
    <div className="min-h-screen bg-[var(--surface-2)] text-[var(--text)] font-sans">
      ...
      {/* Hero Section */}
      <section className="relative h-[40vh] md:h-[70vh] min-h-[300px] md:min-h-[400px] w-full overflow-hidden mt-0">
        ...
        <div className="relative z-20 w-full max-w-[1800px] mx-auto px-4 md:px-8 h-full flex flex-col justify-center">
          <div className="max-w-3xl space-y-10">
            <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold tracking-tight text-white leading-[1.05]">
              Driving <br />
              <span className="text-[var(--primary)]">Excellence</span> <br />
              in Hauling
            </h3>
            <div className="h-1 w-24 bg-[var(--primary)] my-8" />
            <p className="text-base md:text-lg text-white font-medium leading-relaxed max-w-xl mt-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[600px] bg-[var(--border)] rounded-lg overflow-hidden">
               ...
               <div className="absolute bottom-0 left-0 p-8 bg-black/60 backdrop-blur-sm text-white w-full">
                 <p className="text-xl font-semibold">10M+ Miles</p>
      ...
      <section className="py-12 bg-[var(--primary)] text-white text-center">
        <div className="w-full max-w-[1800px] mx-auto px-4 md:px-8 max-w-4xl space-y-8">
          <h2 className="text-3xl md:text-xl font-semibold">Ready to Partner With Us?</h2>
